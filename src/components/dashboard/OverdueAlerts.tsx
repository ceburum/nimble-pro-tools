...
export function OverdueAlerts({ invoices, clients, onSendReminder }: OverdueAlertsProps) {
  const now = new Date();
  ...
  const overdueInvoices = invoices.filter(inv => {
    ...
    return { ...inv, daysOverdue, client, total };
        ...
        {overdueInvoices.slice(0, 5).map(invoice => (
          <div 
            ...
            className={cn(
              ...
              invoice.daysOverdue > 14 ? "border-destructive/50" : 
              invoice.daysOverdue > 7 ? "border-accent/50" : "border-border"
            )}
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className={cn(
                    "text-xs font-medium",
                    invoice.daysOverdue > 14 ? "text-destructive" : 
                    invoice.daysOverdue > 7 ? "text-accent" : "text-muted-foreground"
                  )}>
              ...
              <div className="text-right">
                ...
                <div className="flex gap-1 mt-2">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="h-7 px-2"
                    onClick={() => onSendReminder(invoice, 'text')}
                  >
